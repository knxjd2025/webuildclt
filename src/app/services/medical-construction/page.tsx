...
export const metadata: Metadata = {
  ...
  description:
    'Expert medical and healthcare construction in Charlotte, NC. Medical office buildings, dental practices, urgent care clinics, surgical centers, veterinary clinics & physical therapy facilities. Veteran-owned, HIPAA-compliant layouts, infection control, medical gas systems. Licensed in NC & SC. (704) 574-8124.',
  keywords: [
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'HIPAA requires covered entities to implement physical safeguards that protect patient health information. In construction, this translates to specific design decisions that we integrate from the earliest planning stages. Examination rooms and consultation areas require sound-attenuating wall assemblies, typically STC 50 or higher, to prevent conversations from being overheard in adjacent rooms or corridors. Check-in and registration counters need privacy barriers and spatial separation so that one patient cannot overhear another patient providing personal health information. Medical records storage areas, whether physical or electronic server rooms, require restricted access with lockable doors and access control systems. Computer monitor positioning must be planned so that patient information displayed on screens is not visible to unauthorized individuals in waiting rooms or corridors. We design HIPAA-compliant layouts as a standard element of every medical facility we build, incorporating acoustic privacy, visual privacy, and physical access control into the floor plan from the beginning rather than retrofitting privacy measures after construction.',
  },
  {
