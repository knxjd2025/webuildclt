...
4. Roof Coating (We Coat) — commercial flat roof coatings and restoration
 ...
 */
export const BUSINESS_SUMMARY = `We Build is a veteran and family-owned construction company in Charlotte, NC (HQ: 14330 S Lakes Drive, Charlotte 28273). Services: commercial construction, upfits, roof coating (We Coat), thermal drone inspections (FAA-certified), brewery/restaurant construction, warehouse/industrial, site development, adaptive reuse, value engineering, owner's representative, custom homes. USGBC member. Licensed in NC & SC. 60+ years combined experience. Phone: (980) 471-1745. Website: webuildclt.com.`;
